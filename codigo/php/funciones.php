...
// ✅ Cargar conexión UNA sola vez para todo el archivo
 ...
 * (compatibilidad con código antiguo que usa $_SESSION['user'])
 */
...
/**
 * Exigir un nivel mínimo de rol:
 * 1 = lector (solo ve)
 * 2 = operador (puede escanear, importar DNS, editar)
 * 3 = admin (todo)
 */
