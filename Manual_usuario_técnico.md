...
4. Verificar en el navegador: [http://localhost](http://localhost)

---

### 🐳 2️⃣ Instalar Docker Desktop

1. Descargar desde [https://www.docker.com](https://www.docker.com)  
2. Activar la opción **“Use WSL 2 based engine”**  
...
1. En la carpeta del proyecto (`C:\xampp\htdocs\gestion_ipmac\`) crear el archivo **`docker-compose.yml`** con el siguiente contenido:
